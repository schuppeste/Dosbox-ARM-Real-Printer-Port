...
LDFLAGS = 
LIBOBJS = 
LIBS = -lasound -lm -ldl -lpthread -L/usr/lib/arm-linux-gnueabihf -lSDL -lpng -lz -L/usr/lib/arm-linux-gnueabihf -lfreetype -lz -lpng12  -lX11
LTLIBOBJS = 
MAKEINFO = makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
...
VERSION = SVN
WINDRES = :
abs_builddir = /root/Dosboxsbvntest/db2
abs_srcdir = /root/Dosboxsbvntest/db2
abs_top_builddir = /root/Dosboxsbvntest/db2
abs_top_srcdir = /root/Dosboxsbvntest/db2
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /root/Dosboxsbvntest/db2/install-sh
